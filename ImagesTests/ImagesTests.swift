...
final class ImagesTests: XCTestCase {
    ...
    func testHitDecoderDecodesImage() throws {
        ...
        XCTAssertEqual(hit.webFormat.absoluteString, "https://pixabay.com/get/ed6a99fd0a76647_1280.jpg")
    ...
    func testPixabayJSONDecoderDecodesPixabayJSON() throws {
        ...
        XCTAssertEqual(decoded.hits[0].webFormat.absoluteString, "https://pixabay.com/get/ed6a99fd0a76647_1280.jpg")
